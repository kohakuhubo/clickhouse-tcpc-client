...
public class DataTypeAggregateFunction implements IDataType<Object> {
    ...
    public static DataTypeCreator<Object> creator = (lexer, serverContext) -> {
        ...
        String name = "AggregateFunction(" + functionName + ", " + nestedType.name() + ")";
        return new DataTypeAggregateFunction(nestedType, name);
    };
    ...
    public DataTypeAggregateFunction(IDataType<?> nestedType, String name) {
